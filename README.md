...
- [开发](#开发)
- [架构与实现原理](./docs/ARCHITECTURE.md)（技术文档,中英文）
...
`srv guard status` 看现在是开是关、以及是哪一层设定的。(实现原理见[架构文档的 Guard 一节](./docs/ARCHITECTURE.md#guard)。)
...
架构、各包职责、以及网络/性能、跨平台、guard 等"为什么这样实现"的技术说明,见 [docs/ARCHITECTURE.md](./docs/ARCHITECTURE.md)([English](./docs/ARCHITECTURE.en.md))。

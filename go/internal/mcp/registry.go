		...
		def: toolDef{
			...
			InputSchema: map[string]any{
				...
				"properties": map[string]any{
					...
					"lines":          intSchema(50, "Number of recent lines to fetch (-n). Default 50 sized to fit under the 64 KiB result cap for typical line widths."),
